...
if __name__ == "__main__":
    ...
    g_mqtt_broker_config.client_id = "230502dfdfcdffdfg"
    ...
    # ocr_node = OcrNodeFactory.CreateOcrNode('demo_yjg', 'demo_yjg','temp_window', is_new_kvm_node= True, is_new_app_window=True)
