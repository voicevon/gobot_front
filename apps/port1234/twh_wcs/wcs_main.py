...
from twh_wcs.wcs_workers import Create_WcsWorkers, g_workers
from twh_wcs.wcs_leaders import Create_WcsLeader, g_leaders
...
def WCS_Main(deposit_queue:multiprocessing.Queue):
        ...
        while True:
            for id, leader in g_leaders.items():
                leader.SpinOnce()
            # ????
