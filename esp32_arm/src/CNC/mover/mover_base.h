...
class MoverBase{
    public:
        ...
        void SetActuatorCurrentCncPositionAs(char actuator_name, float as_current_position);
        float GetSingleActuatorCurrentPosition_InCncUnit(char actuator_name);  // TODO: return  all current position.
