...
class CncMoverBase{
    public:
        ...
        virtual void AllMotorsMoveTo(uint8_t is_absolute_position_flags, float* positions_in_cnc_unit, uint8_t target_motor_flags);
        virtual void AllMotorStop();  // TODO: with flags
