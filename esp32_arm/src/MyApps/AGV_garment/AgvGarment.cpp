...
void AgvGarment::SpinOnce_BaseExit(){
    this->MoveToTargetPosition();
}

void AgvGarment::Init_Linkage(IrEncoderHelper* sensorHelperBase){
...
// ik_position AgvGarment::ik(float x, float y){
...
IkPositionBase* AgvGarment::IK(FkPositionBase* fk){
    FkPosX* _fk = (FkPosX*)(fk);
    this->objIkPos.alpha = _fk->x;
    return &this->objIkPos;  
}

FkPositionBase* AgvGarment::FK(IkPositionBase* ik){
