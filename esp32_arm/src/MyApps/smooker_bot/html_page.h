     ...
     function InitWebSocket()
     {
       ...
       websock.onmessage = function(evt)
       {
          ...
          if (first_load){
            ...
            per_volume.value = JSONobj.var_per_volume;
            per_pull_in_second.value = JSONobj.var_pull_in_second;
            per_sleep_in_second.value = JSONobj.var_sleep_in_second;
          }
       }
     }
     //-------------------------------------------------------------
     function onReset(){
       payload = "done_count=0";
