...
void Smoker_G28_Runner::SetMoveBlock_ToHome(EnumAxis_Inverseinematic axis, MoveBlock* mb){
    Logger::Error("Smoker_G28_Runner::SetMoveBlock_ToHome() ---- Inverse axis");
...
void Smoker_G28_Runner::SetMoveBlock_ToHome(EnumAxis_ForwardKinematic axis, MoveBlock* mb){
...
AxisHomer* Smoker_G28_Runner::GetHomer(EnumAxis_ForwardKinematic axis){
    return &__homer;
}

AxisHomer* Smoker_G28_Runner::GetHomer(EnumAxis_Inverseinematic axis){
    return &__homer;
}
