...
void BoxMover_G28_Runner::Init(Board2205Cnc* board, MoverBase* mover){
...
void BoxMover_G28_Runner::SetMoveBlock_ToHome(EnumAxis_Inverseinematic axis, MoveBlock* mb){
    Logger::Error("BoxMover_G28_Runner::SetMoveBlock_ToHome() ---- Inverse axis");
...
void BoxMover_G28_Runner::SetMoveBlock_ToHome(EnumAxis_ForwardKinematic axis, MoveBlock* mb){
