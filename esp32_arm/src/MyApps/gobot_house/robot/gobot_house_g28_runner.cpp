...
void GobotHouse_G28_Runner::SetMoveBlock_ToHome(EnumAxis_Inverseinematic axis, MoveBlock* mb){
    Logger::Error("GobotHouse_G28_Runner::SetMoveBlock_ToHome() ---- Inverse axis");
...
void GobotHouse_G28_Runner::SetMoveBlock_ToHome(EnumAxis_ForwardKinematic axis, MoveBlock* mb){
...
AxisHomer* GobotHouse_G28_Runner::GetHomer(EnumAxis_ForwardKinematic axis){
    return &__homer;
}

AxisHomer* GobotHouse_G28_Runner::GetHomer(EnumAxis_Inverseinematic axis){
    return &__homer;
}
