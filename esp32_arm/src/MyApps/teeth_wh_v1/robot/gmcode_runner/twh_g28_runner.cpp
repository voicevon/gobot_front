...
void Twh1_G28_Runner::Init(CncMover* mover, ArmSolutionBase* arm_solution){
    Logger::Info("Twh1_G28_Runner::Init() Hoiming_config");
    this->_mover = mover;
    this->_arm_solution = arm_solution;
}

void Twh1_G28_Runner::SetMoveBlock_ToHome(char axis, MoveBlock* mb){
    Logger::Debug("Twh1_G28_Runner::SetMoveBlock_ToHome()" );
    ...
    switch (axis){
        case 'Y':
            // Logger::Print("Twh1_G28_Runner::SetMoveBlock_ToHome()  point", 21);
            // Logger::Print("Twh1_G28_Runner::SetMoveBlock_ToHome()  point", 22);
        ...
        case 'a':
            // Logger::Print("Twh1_G28_Runner::SetMoveBlock_ToHome()  point", 31);
            mb->DeepReset_ToDefault();
            // Logger::Print("Twh1_G28_Runner::SetMoveBlock_ToHome()  point", 22);
            alpha->TargetPosition = 99999;
            alpha->Speed = 100;
        ...
        default:
            Logger::Error(" Twh1_G28_Runner::SetMoveBlock_ToHome() Unknown axis");
            Logger::Halt("AcDc::TNT");
            break;
    }
    // Logger::Print("Twh1_G28_Runner::SetMoveBlock_ToHome()  point", 99);
}


void Twh1_G28_Runner::SetHomedPosition(PositionTrigger* firer){
    Logger::Debug("Twh1_G28_Runner::SetHomedPosition()");
    if (this->_axis_name =='a'){
        // do nothing
    }else if (this->_axis_name == 'Y'){
        // must home('a') first, then home('Y')
        // Logger::Print("Twh1_G28_Runner::SetHomedPosition() Y", 31);
        MiddleKinematic mk;
        mk.Arm_Angle = DEG_TO_RAD * (-90);
        mk.Arm_shaft_At_Y= 0;
        // Logger::Print("Twh1_G28_Runner::SetHomedPosition() Y", 32);
        Twh1_XaArmSolution arm;
        FKPosition_XYZRPW fk;
        arm.real_MK_to_FK(&mk, &fk);
        this->_arm_solution->SetCurrentPositionAs(&fk);
        // Logger::Print("Twh1_G28_Runner::SetHomedPosition() Y", 33);

        IKPosition_abgdekl ik;
        arm.real_MK_to_IK(&mk, &ik);
        this->_arm_solution->SetCurrentPositionAs(&ik);
        // Logger::Print("Twh1_G28_Runner::SetHomedPosition() Y", 34);
