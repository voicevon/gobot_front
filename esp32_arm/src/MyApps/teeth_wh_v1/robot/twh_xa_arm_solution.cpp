...
void Twh1_XaArmSolution::real_MK_to_FK(MiddleKinematic* mk, FKPosition_XYZRPY* fk){
...
void Twh1_XaArmSolution::real_FK_to_MK(FKPosition_XYZRPY* fk, MiddleKinematic* mk){
...
void Twh1_XaArmSolution::FK_to_IK(FKPosition_XYZRPY* from_fk,IKPosition_abgdekl* to_ik){
...
void Twh1_XaArmSolution::IK_to_FK(IKPosition_abgdekl* from_ik, FKPosition_XYZRPY*  to_fk){
...
void Twh1_XaArmSolution::MK_to_FK(FKPosition_XYZRPY* from_mk, FKPosition_XYZRPY* to_fk){
	MiddleKinematic mk;
	mk.Arm_shaft_At_Y = from_mk->Y;
	mk.Arm_Angle = from_mk->Roll;
	real_MK_to_FK(&mk, to_fk);
}
void Twh1_XaArmSolution::MK_to_Ik(FKPosition_XYZRPY* from_mk, IKPosition_abgdekl* to_ik){
	MiddleKinematic mk;
	mk.Arm_shaft_At_Y = from_mk->Y;
	mk.Arm_Angle = from_mk->Roll;
	real_MK_to_IK(&mk, to_ik);
...
void Twh1_XaArmSolution::Test_FK_MK_FK(FKPosition_XYZRPY* input){
	MiddleKinematic mk;
