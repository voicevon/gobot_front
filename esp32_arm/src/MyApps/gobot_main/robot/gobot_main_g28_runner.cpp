...
void GobotMain_G28_Runner::Init(GobotMain_Board* board, MoverBase* mover){
...
void GobotMain_G28_Runner::SetMoveBlock_ToHome(EnumAxis_Inverseinematic axis, MoveBlock* mb){
    Logger::Error("GobotMain_G28_Runner::SetMoveBlock_ToHome() ---- Inverse axis");
...
void GobotMain_G28_Runner::SetMoveBlock_ToHome(EnumAxis_ForwardKinematic axis, MoveBlock* mb){
...
AxisHomer* GobotMain_G28_Runner::GetHomer(EnumAxis_ForwardKinematic axis){
    return &__homer;
}

AxisHomer* GobotMain_G28_Runner::GetHomer(EnumAxis_Inverseinematic axis){
    return &__homer;
}
