...
void Twh_LoopPorter_App::ExecuteAppCommand(GcodeText* gcode_text){
    const char command_test_led[8] = {"app:led"};

    Logger::Info("Twh_LoopPorter_App::ExecuteAppCommand()");
    gcode_text->PrintFlat("Twh_LoopPorter_App::ExecuteAppCommand()");
