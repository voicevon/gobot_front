...
extern void set_callback_mqtt_read_payload( int (*service_function)(const char*, char*) );
extern void set_callback_mqtt_release_buffer(void (*service_function) (const char*));
